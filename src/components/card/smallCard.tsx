  ...
  return (
    <>
      <div className=" bg-[#F3F4F4] border-[#F3F4F4] p-4 w-full">
        <a className="block relative h-[150px] rounded-md overflow-hidden">
          <img
            alt="ecommerce"
   ...
   <StarIcon key={index} className="xl:h-4 xl:w-4 lg:w-3 lg:h-3 md:w-3 md:h-3 sm:w-2 sm:h-2 w-3 h-3 text-[#ffa947]" />
          ...
          <div className="flex justify-between">
            ...
            <div className="space-x-2">
              ...
              <HeartIcon className="xl:w-7 xl:h-7 lg:w-5 lg:h-5 md:w-5 md:h-5 sm:w-5 sm:h-5 text-white" />
              </button>
              <button className="p-1 bg-[#FF4747] rounded-full shadow-md">
              <ShoppingCartIcon className="xl:w-7 xl:h-7 lg:w-5 lg:h-5 md:w-5 md:h-5 sm:w-5 sm:h-5 text-white" />
              </button>
            </div>
          </div>
        </div>
