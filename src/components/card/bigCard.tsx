  ...
  return (
    <>
      <div className=" bg-[#F3F4F4] border-[#F3F4F4] p-4 w-full rounded-md mb-3">
        ...
        <div className="mt-3">
          <h3 className="xl:text-xl lg:text-lg md:text-md sm:text-md font-bold mb-1">
          ...
          <div className="flex flex-row items-center">
            {[...Array(product?.starsCount)].map((_, index) => (
              <StarIcon
                key={index}
                className="xl:h-4 xl:w-4 lg:w-3 lg:h-3 md:w-3 md:h-3 sm:w-2 sm:h-2 w-3 h-3 text-[#ffa947]"
              />
            ))}
          ...
          <div className="flex justify-between">
            <p className="mt-1 xl:text-2xl lg:text-lg md:text-md sm:text-md xs:md:text-sm text-[#FF4747]">
